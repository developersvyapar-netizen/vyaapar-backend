...
| [Cart](./cart.md) | Shopping cart and order creation (salesperson) | [View Docs](./cart.md) |
| [Retailer Orders](./retailer-orders.md) | Direct ordering by retailers (no salesperson needed) | [View Docs](./retailer-orders.md) |
...
| `RETAILER` | Retail seller | Retailer dashboard, direct ordering from distributors |
...
| 1.4.0 | 2026-02-12 | Added retailer direct ordering (POST /api/retailer/orders); salespersonId now optional on orders; order detail accessible by buyer/supplier |
